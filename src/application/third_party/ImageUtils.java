...
public class ImageUtils {
     ...
     * Resizes an image
     *
     * @param imgName The image name to resize. Must be the complet path to the
     * file
     * @param type int
     ...
     * @param type The image type. Use <code>ImageUtils.IMAGE_JPEG</code> to
     * save as JPEG images, or <code>ImageUtils.IMAGE_PNG</code> to save as PNG.
